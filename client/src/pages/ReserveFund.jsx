    ...
    <div className="space-y-6">
      {summary ? (
        <AccordionSection
          ...
          description="Current reserve position and cumulative inflow/outflow totals."
          icon={Lock}
      ...
      <AccordionSection
        ...
        description="How the reserve fund is used inside the current fund workflow."
        icon={Lock}
      >
      ...
      <AccordionSection
        ...
        description="Recorded reserve contributions and releases from the database."
        icon={Lock}
        badge={rows.length}
      >
