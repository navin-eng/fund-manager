...
export default function Distributions() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Distribution Rounds */}
      <h3 className="text-sm font-semibold text-slate-700 uppercase tracking-wider">Distribution Rounds</h3>
      ...
      {/* Raw Ledger */}
      <h3 className="text-sm font-semibold text-slate-700 uppercase tracking-wider">Raw Distribution Ledger</h3>
