...
const TYPE_BADGES = {
  ...
  wd: { label: 'Withdrawal', cls: 'bg-rose-100 text-rose-700' },
  lo: { label: 'Loan Out', cls: 'bg-amber-100 text-amber-700' },
  clr: { label: 'Repayment', cls: 'bg-green-100 text-green-700' },
  int: { label: 'Interest', cls: 'bg-purple-100 text-purple-700' },
  pen: { label: 'Penalty', cls: 'bg-orange-100 text-orange-700' },
    ...
    <div className="space-y-6">
      {summary ? (
        <AccordionSection
          ...
          description="A quick snapshot of automated inflows, outflows, and the latest running balance."
          icon={BookOpen}
          badge={summary.total_entries}
        >
      ...
      <AccordionSection
        ...
        description="Search the generated ledger by particulars or accounting type."
        icon={Filter}
      >
      ...
      <AccordionSection
        ...
        description="Every fund movement is listed in sequence with its running balance."
        icon={ArrowUpDown}
